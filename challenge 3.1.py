...
enumerate(product_list): if product == target_product: indices.append(i) return indices
...
linear_search_product(products, if result:

target)

print(f"The product '{target}' was found at indices: {result}") else:
